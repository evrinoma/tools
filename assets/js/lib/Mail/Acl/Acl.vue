    ...
    export default {
        ...
        data() {
            return {
                ...
                apiUrlAclModel: window.location.origin+'/internal/acl/model',
                apiUrlDomains: window.location.origin+'/internal/domain/domain',
                apiUrlAcl: window.location.origin+'/internal/acl/acl',
                apiUrlAclSave: window.location.origin+'/internal/acl/save',
                apiUrlAclClass: window.location.origin+'/internal/acl/class',

                apiUrlSpam: window.location.origin+'/internal/spam/rules',
                apiUrlSpamType: window.location.origin+'/internal/spam/rules_type',
                apiUrlConformityModel: window.location.origin+'/internal/spam/conformity',
                apiUrlSpamSave: window.location.origin+'/internal/spam/save',
                apiUrlSpamClass: window.location.origin+'/internal/spam/class',
